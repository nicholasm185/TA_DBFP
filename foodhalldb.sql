...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2020 at 05:22 PM
...
(7, '1 Food Hall Senayan City', 'aa', '123456', 20000, 50),
...
--
ALTER TABLE `cashier`
  MODIFY `cashierID` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
